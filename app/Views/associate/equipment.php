<div class="py-5 sm:ml-64 font-regular">
    <div class="container mx-auto bg-gray-900 shadow-md rounded-lg p-6 overflow-x-auto">
        <h1 class="text-3xl font-bold mb-6 text-white">Equipment List</h1>

        <!-- Add filter section if needed -->
        <div class="mb-4 flex items-center">
            <label for="filter-type" class="text-white mr-2">Search:</label>
            <input id="filter-input" type="text"
                class="px-4 py-2 rounded bg-gray-800 text-gray-300 border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
        ...
        <table class="min-w-full divide-y divide-gray-700">
            <thead class="bg-gray-800">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-300 uppercase tracking-wider">Category
                    </th>
            ...
            <tbody id="equipment-table" class="bg-gray-900 divide-y divide-gray-700">
                ...
                <tr>
                    <td class="px-6 py-4 whitespace-nowrap text-gray-100"><?= $item['equipment_id'] ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-gray-100"><?= $item['name'] ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-gray-100"><?= $item['category'] ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-gray-100"><?= ucfirst($item['status']) ?></td>
