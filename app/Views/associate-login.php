                            ...
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form>
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="text" id="associateNumber" class="form-control border-color" />
                                        <label class="form-label" for="associateNumber">Associate Number</label>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <div class="input-group">
                                            <input type="password" id="password" class="form-control border-color" />
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button data-mdb-button-init data-mdb-ripple-init class="btn login-btn w-100 btn-block"
                                                type="button" style="background-color: #0b3612; color: #fff;">Login</button>
                                    </div>

                                    <a class="small text-muted" href="<?= base_url('forgot-password') ?>">Forgot password?</a>
                                    <p class="mb-5 pb-lg-2 text-success">Don't have an account? <a
                                                href="<?= base_url('register') ?>" class="text-success">Register here</a></p>
                                </form>
